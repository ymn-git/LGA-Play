...
def update_positive_goal_difference(goal_difference, team_id: int):
    return teams_repo.update_positive_goal_difference(
        goal_difference, team_id
    )


def update_negative_goal_difference(goal_difference, team_id: int):
    return teams_repo.update_negative_goal_difference(
        goal_difference, team_id
    )
...
def match_result(match):
    ...
    update_positive_goal_difference(
        goal_difference,
        winner
    )

    teams_repo.add_loss(looser)
    update_negative_goal_difference(
        goal_difference,
        looser
    )
...
def add_tie(teamA_id, teamB_id):
    return teams_repo.update_draw_to_both(
        teamA_id,
        teamB_id
    )